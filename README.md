# ilw-accordion-controller

Links: **[ilw-accordion-controller in Builder](https://builder3.toolkit.illinois.edu/component/ilw-accordion-controller/index.html)** | 
...
```html
<ilw-accordion-controller></ilw-accordion-controller>
```
